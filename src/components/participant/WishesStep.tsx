...
import { Plus, Trash2, Gift, Heart, DollarSign, RotateCcw } from "lucide-react";
...
const translations = {
  de: {
    ...
    replayAnimation: "Nochmal ansehen",
  },
  en: {
      ...
      <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-bold text-black flex items-center gap-2">
                ...
                {t.priceLimit}: {room.price_limit} {room.currency}
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <Card className="bg-[#FDFB9C] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-6 h-full">
              ...
              <div className="space-y-2">
                {drawnParticipantWishes && drawnParticipantWishes.length > 0 ? (
                  drawnParticipantWishes.map((wish: string, index: number) => (
                    <motion.div
                      key={index}
                    ...
                    >
                      <p className="text-lg font-bold text-black">• {wish}</p>
                    </motion.div>
                  ))
                ) : (
        ...
        {onBack && (
          ...
          >
            <Button
              onClick={onBack}
              className="border-4 border-black bg-[#FDFB9C] hover:bg-[#FDF080] h-12 px-6 text-lg font-black text-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all"
            >
